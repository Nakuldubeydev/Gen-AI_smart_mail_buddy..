import { n as __exportAll, r as __toESM } from "./chunk-CaR5F9JI.js";
import { $ as createTheme$1, A as decomposeColor, B as useEnhancedEffect, C as useId, Ct as green, D as exactProp, Dt as red, E as useRtl, Et as purple, F as hslToRgb, G as generateUtilityClasses, H as getThemeProps, I as lighten, K as generateUtilityClass, L as recomposeColor, M as getContrastRatio, N as getLuminance, O as alpha, Ot as common, P as hexToRgb, Q as useTheme$1, R as rgbToHex, St as orange, Tt as blue, U as resolveProps, V as useThemeProps$1, W as styled$1, Y as extendSxProp$1, Z as useTheme$2, _ as createContainer, _t as createCache, bt as identifier_default, c as excludeVariablesFromRoot, ct as resolveBreakpointValues, d as getOverlayAlpha, dt as require_react_is, f as createTransitions, g as createMixins, gt as CacheProvider, h as createTypography, ht as keyframes, i as useTheme, it as getPath, j as emphasize, k as darken, l as shouldSkipGeneratingVar, lt as createBreakpoints, m as easing, mt as css, n as rootShouldForwardProp, nt as createUnarySpacing, o as createTheme, ot as handleBreakpoints, p as duration, pt as require_prop_types, q as clsx, r as slotShouldForwardProp, rt as getValue, s as createThemeWithVars, st as mergeBreakpointsInOrder, t as styled, u as createColorScheme, ut as deepmerge, v as composeClasses, vt as StyleSheet, wt as lightBlue, xt as grey, z as clamp } from "./styled-nmhlPe4d.js";
import { t as require_react } from "./react-zm2fn-FP.js";
import { t as require_jsx_runtime } from "./jsx-runtime-DwHWCUOo.js";
import { _ as toUnitless, a as withTheme, b as adaptV4Theme, c as ThemeProvider, d as getInitColorSchemeScript, f as useColorScheme, g as getUnit, h as responsiveFontSizes, i as deprecatedExtendTheme, l as CssVarsProvider, m as useThemeProps, n as boxClasses, o as withStyles, p as InitColorSchemeScript, r as experimental_sx, s as makeStyles, t as Box, u as Experimental_CssVarsProvider, v as createStyles, y as createMuiStrictModeTheme } from "./Box-CSfSFY98.js";
import { i as isMuiElement, r as isMuiElement_default } from "./utils-lz9NZrWp.js";
import { n as FormControlContext, r as capitalize_default, t as useFormControl } from "./useFormControl-Dsh5LkBZ.js";
import { $ as paperClasses, A as ModalManager, B as outlinedInputClasses, C as Grow, Ct as getSvgIconUtilityClass, D as modalClasses, E as getModalUtilityClass, F as elementAcceptingRef, G as inputBaseClasses, H as inputClasses, I as ArrowDropDown_default, J as getReactElementRef, K as TextareaAutosize, L as filledInputClasses, M as backdropClasses, N as getBackdropUtilityClass, O as FocusTrap, P as Fade, Q as getPaperUtilityClass, R as getFilledInputUtilityClass, S as Input, St as SvgIcon, T as Modal, Tt as createChainedFunction_default, U as InputBase, V as getInputUtilityClass, W as getInputBaseUtilityClass, X as HTMLElementType, Y as useSlotProps, Z as Paper, _ as popoverClasses, _t as ownerDocument_default, a as NativeSelectInput, at as reflow, b as getListUtilityClass, bt as debounce_default, c as Menu, ct as mergeSlotProps, d as Popover, dt as unsupportedProp_default, et as integerPropType, f as PopoverPaper, ft as useId_default, g as getPopoverUtilityClass, gt as ownerWindow_default, h as getOffsetTop, ht as requirePropFactory_default, i as OutlinedInput, it as getTransitionProps, j as Backdrop, k as getActiveElement_default, l as getMenuUtilityClass, lt as useControlled_default, m as getOffsetLeft, mt as setRef, n as getSelectUtilityClasses, nt as extractEventHandlers, o as getNativeSelectUtilityClasses, ot as Transition, p as PopoverRoot, pt as setRef_default, q as Portal, r as selectClasses, rt as isHostComponent, s as nativeSelectClasses, st as unstable_ClassNameGenerator, t as Select, tt as useSlot, u as menuClasses, ut as useControlled, v as MenuList, vt as ownerDocument, w as FilledInput, wt as svgIconClasses, x as listClasses, xt as createSvgIcon, y as List, yt as deprecatedPropType_default, z as getOutlinedInputUtilityClass } from "./Select-GPtOPvym.js";
import { i as GlobalStyles, n as globalCss, r as internal_createExtendSxProp, t as useDefaultProps } from "./DefaultPropsProvider-BR8UR-Y7.js";
import { t as memoTheme } from "./memoTheme-WBiqmpj9.js";
import { a as useTimeout, d as useForkRef_default, f as useForkRef, h as useEnhancedEffect_default, i as Timeout, m as useEventCallback, n as refType, p as useEventCallback_default, r as elementTypeAcceptingRef_default, t as ListContext, u as chainPropTypes } from "./ListContext-D0fsfLpI.js";
import { t as require_react_dom } from "./react-dom-DOgu6wsC.js";
import { a as listItemTextClasses, c as dividerClasses, d as buttonBaseClasses, f as getButtonBaseUtilityClass, h as isFocusVisible, i as getListItemTextUtilityClass, l as getDividerUtilityClass, m as touchRippleClasses, n as getMenuItemUtilityClass, o as getListItemIconUtilityClass, p as getTouchRippleUtilityClass, r as menuItemClasses, s as listItemIconClasses, t as MenuItem, u as ButtonBase } from "./MenuItem-CJRrP64s.js";
import { n as createSimplePaletteValueFilter, t as formControlState } from "./formControlState-CtUN0DQz.js";
import { n as formControlClasses, r as getFormControlUtilityClasses, t as FormControl } from "./FormControl-BZdJAGiQ.js";
import { a as FormLabelRoot, i as FormLabel, n as getInputLabelUtilityClasses, o as formLabelClasses, r as inputLabelClasses, s as getFormLabelUtilityClasses, t as InputLabel } from "./InputLabel-DXINy7vg.js";
...
var AccordionActions = /* @__PURE__ */ import_react.forwardRef(function AccordionActions(inProps, ref) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AccordionActionsRoot, {
		className: clsx(useUtilityClasses$94(ownerState).root, className),
		ref,
		ownerState,
		...other
	});
...
var AccordionDetails = /* @__PURE__ */ import_react.forwardRef(function AccordionDetails(inProps, ref) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AccordionDetailsRoot, {
		className: clsx(useUtilityClasses$93(ownerState).root, className),
		ref,
		ownerState,
		...other
	});
...
var AppBar = /* @__PURE__ */ import_react.forwardRef(function AppBar(inProps, ref) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AppBarRoot, {
		...
		ownerState,
		elevation: 4,
		className: clsx(useUtilityClasses$86(ownerState).root, className, position === "fixed" && "mui-fixed"),
		ref,
		...other
	});
});
	...
	*/
	...
	useEnhancedEffect(() => {
		...
		if (resolvedAnchorElement && isHTMLElement(resolvedAnchorElement) && resolvedAnchorElement.nodeType === 1) {
			...
			if (!globalThis.MUI_TEST_ENV && box.top === 0 && box.left === 0 && box.right === 0 && box.bottom === 0) console.warn([
	...
	anchorEl: chainPropTypes(import_prop_types.default.oneOfType([
		...
		if (props.open) {
			...
			if (resolvedAnchorEl && isHTMLElement(resolvedAnchorEl) && resolvedAnchorEl.nodeType === 1) {
				...
				if (!globalThis.MUI_TEST_ENV && box.top === 0 && box.left === 0 && box.right === 0 && box.bottom === 0) return new Error([
					"MUI: The `anchorEl` prop provided to the component is invalid.",
					"The anchor element should be part of the document layout.",
					"Make sure the element is present in the document or that it's not display none."
				].join("\n"));
...
var BottomNavigation = /* @__PURE__ */ import_react.forwardRef(function BottomNavigation(inProps, ref) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BottomNavigationRoot, {
		as: component,
		className: clsx(useUtilityClasses$78(ownerState).root, className),
		ref,
		ownerState,
		...other,
...
var useUtilityClasses$35 = (props) => {
...
var RadioGroup = /* @__PURE__ */ import_react.forwardRef(function RadioGroup(props, ref) {
	...
	const classes = useUtilityClasses$35(props);
	...
	const getTabsMeta = () => {
		...
		if (tabsNode && value !== false) {
			...
			if (children.length > 0) {
				...
				if (!globalThis.MUI_TEST_ENV && !warnedOnceTabPresent && tabMeta && tabMeta.width === 0 && tabMeta.height === 0 && tabsMeta.clientWidth !== 0) {
					tabsMeta = null;
					console.error([
						"MUI: The `value` provided to the Tabs component is invalid.",
